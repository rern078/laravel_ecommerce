...
<main id="main" class="main">
      ...
      <section class="section">
            <div class="row">
                  <form class="subcategory" action="{{ route('addSubCategories') }}" method="POST" enctype="multipart/form-data">
                        @if ($errors->any())
                                    ...
                                    <div class="card">
                                          <div class="card-body">
                                                ...
                                                <div class="row mb-3">
                                                      ...
                                                      <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="subcategory_slug" id="subcategory_slug" placeholder="Category Slug" oninput="this.value = this.value.toLowerCase().replace(/\s+/g, '-')" pattern="[a-z0-9-]+" title="Only lowercase letters, numbers, and hyphens are allowed">
                                                      </div>
                                                </div>
                                                <div class="row mb-3">
                                                      <label for="subcategory_code" class="col-sm-2 col-form-label">Sub Category Code<span>*</span></label>
                                                      <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="subcategory_code" id="subcategory_code" placeholder="Sub Category Code">
                                                      </div>
                                                </div>
                                                <div class="row mb-3">
                                                      <label for="meta_title" class="col-sm-2 col-form-label">Sub Category Title</label>
                                                      <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="meta_title" placeholder="Sub Category Title">
                                                      </div>
                                                </div>
                                                <div class="row mb-3">
                                                      <label for="meta_description" class="col-sm-2 col-form-label">Sub Category Description</label>
                                                      <div class="col-sm-10">
                                                            <textarea name="meta_description" id="" class="form-control" cols="30" rows="5" placeholder="Sub Category Description"></textarea>
                                                      </div>
                                                </div>
                                                <div class="row mb-3">
                                                      <label for="meta_keyword" class="col-sm-2 col-form-label">Sub Category Keyword</label>
                                                      <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="meta_keyword" placeholder="Sub Category Keyword">
                                                      </div>
                                                </div>
